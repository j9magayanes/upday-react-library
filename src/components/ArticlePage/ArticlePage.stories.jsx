...
export default {
  ...
  Meinestadt.args = {
    ...
    size: 'meinestadt',
    class: 'ad',
    src: 'https://assets-static.invideo.io/images/large/Facebook_black_Friday_ads_1f13ff37f9.webp',
  ...
  Web.args = {
    ...
    args:{   src: 'https://img.yana.asideas.de/image/upload/w_700,h_394,c_fill,f_webp,q_auto:eco/v1689066061/cms-cropped/hesgy7puvocvswz5pxw6.jpg', appName: 'web', category: 'Business', title: 'Selenskyj fordert EU-Beitrittsverhandlungen', source: 'Upday Web', detail: '> 1 day',  fulltext: 'Mehr als 16 Monate nach Beginn des russischen Angriffskriegs hat der ukrainische Präsident Wolodymyr Selenskyj die Forderung nach einer baldigen konkreten EU-Beitrittsperspektive für sein Land erneuert. „Die Ukraine hat Einfluss auf die Stärke Europas. Das ist ein Fakt“, sagte Selenskyj am Donnerstag in seiner abendlichen Videoansprache. „Und dieses Jahr ist es an der Zeit, diesen und andere Fakten zu nutzen, um die Einheit in Europa zu stärken – angefangen beim Start von Verhandlungen über die EU-Mitgliedschaft der Ukraine.“',  text: 'Read More', id: 'web', class: 'hero' }
